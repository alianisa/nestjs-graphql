...
import { SALON_TITLE_FIELD } from "./SalonTitle";
...
export const SalonShow = (props: ShowProps): React.ReactElement => {
  return (
    <Show {...props}>
      <SimpleShowLayout>
        ...
        <ReferenceManyField reference="Order" target="salon_id" label="Orders">
          <Datagrid rowClick="show" bulkActionButtons={false}>
        ...
        <ReferenceManyField reference="Queue" target="salon_id" label="Queues">
          <Datagrid rowClick="show" bulkActionButtons={false}>
            <BooleanField label="Completed" source="completed" />
            <TextField label="Completed At" source="completedAt" />
            <TextField label="Created At" source="createdAt" />
