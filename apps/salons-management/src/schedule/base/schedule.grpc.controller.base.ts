...
export class ScheduleGrpcControllerBase {
    ...
    return await this.service.createSchedule({
      data: {
        ...
        userProfilesScheduleBarberIdTouserProfiles: {
          connect: data.userProfilesScheduleBarberIdTouserProfiles,
        },

        userProfilesScheduleUserIdTouserProfiles: {
          connect: data.userProfilesScheduleUserIdTouserProfiles,
        },
      },
      select: {
  ...
  @GrpcMethod("ScheduleService", "schedules")
  ...
  @GrpcMethod("ScheduleService", "schedule")
  async schedule(
  ...
  @swagger.ApiOkResponse({ type: Schedule })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("ScheduleService", "updateSchedule")
