...
export class ScheduleResolverBase {
    ...
    return await this.service.createSchedule({
      ...
      data: {
        ...
        userProfilesScheduleBarberIdTouserProfiles: {
          connect: args.data.userProfilesScheduleBarberIdTouserProfiles,
        },

        userProfilesScheduleUserIdTouserProfiles: {
          connect: args.data.userProfilesScheduleUserIdTouserProfiles,
        },
      },
    });
  }
  ...
  async getUserProfilesScheduleBarberIdTouserProfiles(
    ...
    const result =
      await this.service.getUserProfilesScheduleBarberIdTouserProfiles(
        parent.id
      );
  ...
  async getUserProfilesScheduleUserIdTouserProfiles(
    ...
    const result =
      await this.service.getUserProfilesScheduleUserIdTouserProfiles(parent.id);
