...
export class SalonRatingLikeGrpcControllerBase {
  ...
  @GrpcMethod("SalonRatingLikeService", "salonRatingLikes")
  ...
  @GrpcMethod("SalonRatingLikeService", "salonRatingLike")
  ...
  @swagger.ApiOkResponse({ type: SalonRatingLike })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("SalonRatingLikeService", "updateSalonRatingLike")
  ...
  @swagger.ApiOkResponse({ type: SalonRatingLike })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("SalonRatingLikeService", "deleteSalonRatingLike")
