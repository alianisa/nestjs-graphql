...
@InputType()
class SamlRelayStateUpdateManyWithoutFlowStatesInput {
...
export { SamlRelayStateUpdateManyWithoutFlowStatesInput as SamlRelayStateUpdateManyWithoutFlowStatesInput };
