...
@InputType()
class SamlRelayStateCreateNestedManyWithoutFlowStatesInput {
...
export { SamlRelayStateCreateNestedManyWithoutFlowStatesInput as SamlRelayStateCreateNestedManyWithoutFlowStatesInput };
