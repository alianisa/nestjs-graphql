...
export class SalonstestGrpcControllerBase {
  ...
  @GrpcMethod("SalonstestService", "salonstests")
  ...
  @GrpcMethod("SalonstestService", "salonstest")
  async salonstest(
  ...
  @swagger.ApiOkResponse({ type: Salonstest })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("SalonstestService", "updateSalonstest")
  ...
  @swagger.ApiOkResponse({ type: Salonstest })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("SalonstestService", "deleteSalonstest")
