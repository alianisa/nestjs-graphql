...
@InputType()
class ChatMessageUpdateManyWithoutUserProfilesInput {
...
export { ChatMessageUpdateManyWithoutUserProfilesInput as ChatMessageUpdateManyWithoutUserProfilesInput };
