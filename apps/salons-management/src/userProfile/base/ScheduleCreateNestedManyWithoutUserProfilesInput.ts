...
@InputType()
class ScheduleCreateNestedManyWithoutUserProfilesInput {
...
export { ScheduleCreateNestedManyWithoutUserProfilesInput as ScheduleCreateNestedManyWithoutUserProfilesInput };
