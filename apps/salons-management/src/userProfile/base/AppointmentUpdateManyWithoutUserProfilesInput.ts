...
@InputType()
class AppointmentUpdateManyWithoutUserProfilesInput {
...
export { AppointmentUpdateManyWithoutUserProfilesInput as AppointmentUpdateManyWithoutUserProfilesInput };
