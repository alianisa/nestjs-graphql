...
@InputType()
class UserAccountCreateNestedManyWithoutUserProfilesInput {
...
export { UserAccountCreateNestedManyWithoutUserProfilesInput as UserAccountCreateNestedManyWithoutUserProfilesInput };
