...
@InputType()
class NotificationUpdateManyWithoutUserProfilesInput {
...
export { NotificationUpdateManyWithoutUserProfilesInput as NotificationUpdateManyWithoutUserProfilesInput };
