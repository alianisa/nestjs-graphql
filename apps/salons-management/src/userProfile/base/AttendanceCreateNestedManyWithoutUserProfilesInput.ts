...
@InputType()
class AttendanceCreateNestedManyWithoutUserProfilesInput {
...
export { AttendanceCreateNestedManyWithoutUserProfilesInput as AttendanceCreateNestedManyWithoutUserProfilesInput };
