...
@InputType()
class ChatMessageCreateNestedManyWithoutUserProfilesInput {
...
export { ChatMessageCreateNestedManyWithoutUserProfilesInput as ChatMessageCreateNestedManyWithoutUserProfilesInput };
