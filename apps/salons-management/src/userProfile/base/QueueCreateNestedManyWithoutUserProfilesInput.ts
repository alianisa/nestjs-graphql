...
@InputType()
class QueueCreateNestedManyWithoutUserProfilesInput {
...
export { QueueCreateNestedManyWithoutUserProfilesInput as QueueCreateNestedManyWithoutUserProfilesInput };
