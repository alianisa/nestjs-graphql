...
@InputType()
class EmployeeDailyStatUpdateManyWithoutUserProfilesInput {
...
export { EmployeeDailyStatUpdateManyWithoutUserProfilesInput as EmployeeDailyStatUpdateManyWithoutUserProfilesInput };
