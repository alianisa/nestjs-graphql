...
@InputType()
class UserAccountUpdateManyWithoutUserProfilesInput {
...
export { UserAccountUpdateManyWithoutUserProfilesInput as UserAccountUpdateManyWithoutUserProfilesInput };
