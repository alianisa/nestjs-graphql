...
@InputType()
class SalonRatingCreateNestedManyWithoutUserProfilesInput {
...
export { SalonRatingCreateNestedManyWithoutUserProfilesInput as SalonRatingCreateNestedManyWithoutUserProfilesInput };
