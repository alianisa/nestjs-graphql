...
@InputType()
class UserAddressCreateNestedManyWithoutUserProfilesInput {
...
export { UserAddressCreateNestedManyWithoutUserProfilesInput as UserAddressCreateNestedManyWithoutUserProfilesInput };
