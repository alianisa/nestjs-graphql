...
@InputType()
class AppointmentCreateNestedManyWithoutUserProfilesInput {
...
export { AppointmentCreateNestedManyWithoutUserProfilesInput as AppointmentCreateNestedManyWithoutUserProfilesInput };
