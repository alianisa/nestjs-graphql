...
@InputType()
class TimeSlotCreateNestedManyWithoutUserProfilesInput {
...
export { TimeSlotCreateNestedManyWithoutUserProfilesInput as TimeSlotCreateNestedManyWithoutUserProfilesInput };
