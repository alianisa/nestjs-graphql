...
@InputType()
class UserAddressUpdateManyWithoutUserProfilesInput {
...
export { UserAddressUpdateManyWithoutUserProfilesInput as UserAddressUpdateManyWithoutUserProfilesInput };
