...
@InputType()
class EmployeeTaskUpdateManyWithoutUserProfilesInput {
...
export { EmployeeTaskUpdateManyWithoutUserProfilesInput as EmployeeTaskUpdateManyWithoutUserProfilesInput };
