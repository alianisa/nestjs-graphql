...
export class MfaAmrClaimGrpcControllerBase {
  ...
  @GrpcMethod("MfaAmrClaimService", "mfaAmrClaims")
  ...
  @GrpcMethod("MfaAmrClaimService", "mfaAmrClaim")
  async mfaAmrClaim(
  ...
  @swagger.ApiOkResponse({ type: MfaAmrClaim })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("MfaAmrClaimService", "updateMfaAmrClaim")
  ...
  @swagger.ApiOkResponse({ type: MfaAmrClaim })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("MfaAmrClaimService", "deleteMfaAmrClaim")
