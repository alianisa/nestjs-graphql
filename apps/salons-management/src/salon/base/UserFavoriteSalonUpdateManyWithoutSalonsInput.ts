...
@InputType()
class UserFavoriteSalonUpdateManyWithoutSalonsInput {
...
export { UserFavoriteSalonUpdateManyWithoutSalonsInput as UserFavoriteSalonUpdateManyWithoutSalonsInput };
