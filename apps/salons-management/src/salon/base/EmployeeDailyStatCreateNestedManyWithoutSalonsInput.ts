...
@InputType()
class EmployeeDailyStatCreateNestedManyWithoutSalonsInput {
...
export { EmployeeDailyStatCreateNestedManyWithoutSalonsInput as EmployeeDailyStatCreateNestedManyWithoutSalonsInput };
