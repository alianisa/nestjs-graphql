...
@InputType()
class SalonRatingCreateNestedManyWithoutSalonsInput {
...
export { SalonRatingCreateNestedManyWithoutSalonsInput as SalonRatingCreateNestedManyWithoutSalonsInput };
