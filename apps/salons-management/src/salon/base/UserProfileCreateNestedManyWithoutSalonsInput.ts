...
@InputType()
class UserProfileCreateNestedManyWithoutSalonsInput {
...
export { UserProfileCreateNestedManyWithoutSalonsInput as UserProfileCreateNestedManyWithoutSalonsInput };
