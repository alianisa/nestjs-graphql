...
@InputType()
class UserAccountCreateNestedManyWithoutSalonsInput {
...
export { UserAccountCreateNestedManyWithoutSalonsInput as UserAccountCreateNestedManyWithoutSalonsInput };
