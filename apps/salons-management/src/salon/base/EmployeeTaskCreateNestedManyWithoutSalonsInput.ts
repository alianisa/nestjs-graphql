...
@InputType()
class EmployeeTaskCreateNestedManyWithoutSalonsInput {
...
export { EmployeeTaskCreateNestedManyWithoutSalonsInput as EmployeeTaskCreateNestedManyWithoutSalonsInput };
