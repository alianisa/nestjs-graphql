...
export class AuditLogEntryGrpcControllerBase {
  ...
  @GrpcMethod("AuditLogEntryService", "auditLogEntries")
  ...
  @GrpcMethod("AuditLogEntryService", "auditLogEntry")
  async auditLogEntry(
  ...
  @swagger.ApiOkResponse({ type: AuditLogEntry })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("AuditLogEntryService", "updateAuditLogEntry")
  ...
  @swagger.ApiOkResponse({ type: AuditLogEntry })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("AuditLogEntryService", "deleteAuditLogEntry")
