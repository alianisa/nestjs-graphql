...
@InputType()
class SamlRelayStateCreateNestedManyWithoutSsoProvidersInput {
...
export { SamlRelayStateCreateNestedManyWithoutSsoProvidersInput as SamlRelayStateCreateNestedManyWithoutSsoProvidersInput };
