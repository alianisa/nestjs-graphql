...
@InputType()
class ChatMessageUpdateManyWithoutChatMessagesInput {
...
export { ChatMessageUpdateManyWithoutChatMessagesInput as ChatMessageUpdateManyWithoutChatMessagesInput };
