...
@InputType()
class ChatMessageCreateNestedManyWithoutChatMessagesInput {
...
export { ChatMessageCreateNestedManyWithoutChatMessagesInput as ChatMessageCreateNestedManyWithoutChatMessagesInput };
