...
export class ChatMessageResolverBase {
  ...
  async createChatMessage(
    ...
    return await this.service.createChatMessage({
      ...
      data: {
        ...
        chatMessages: args.data.chatMessages
          ? {
              connect: args.data.chatMessages,
            }
          : undefined,
  ...
  async findOtherChatMessages(
    ...
    const results = await this.service.findOtherChatMessages(parent.id, args);
  ...
  async getChatMessages(
    ...
    const result = await this.service.getChatMessages(parent.id);
