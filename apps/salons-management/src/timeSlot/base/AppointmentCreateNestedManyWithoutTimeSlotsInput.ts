...
@InputType()
class AppointmentCreateNestedManyWithoutTimeSlotsInput {
...
export { AppointmentCreateNestedManyWithoutTimeSlotsInput as AppointmentCreateNestedManyWithoutTimeSlotsInput };
