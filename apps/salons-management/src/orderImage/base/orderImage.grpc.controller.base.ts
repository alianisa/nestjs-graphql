...
export class OrderImageGrpcControllerBase {
  ...
  @GrpcMethod("OrderImageService", "orderImages")
  ...
  @GrpcMethod("OrderImageService", "orderImage")
  async orderImage(
  ...
  @swagger.ApiOkResponse({ type: OrderImage })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("OrderImageService", "updateOrderImage")
  ...
  @swagger.ApiOkResponse({ type: OrderImage })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("OrderImageService", "deleteOrderImage")
