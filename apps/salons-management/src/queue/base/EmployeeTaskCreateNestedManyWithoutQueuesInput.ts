...
@InputType()
class EmployeeTaskCreateNestedManyWithoutQueuesInput {
...
export { EmployeeTaskCreateNestedManyWithoutQueuesInput as EmployeeTaskCreateNestedManyWithoutQueuesInput };
