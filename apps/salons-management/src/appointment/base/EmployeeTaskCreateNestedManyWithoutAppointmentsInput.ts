...
@InputType()
class EmployeeTaskCreateNestedManyWithoutAppointmentsInput {
...
export { EmployeeTaskCreateNestedManyWithoutAppointmentsInput as EmployeeTaskCreateNestedManyWithoutAppointmentsInput };
