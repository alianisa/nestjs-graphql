    ...
    return await this.service.createChat({
      data: {
        ...
        userProfilesChatsUserATouserProfiles:
          data.userProfilesChatsUserATouserProfiles
            ? {
                connect: data.userProfilesChatsUserATouserProfiles,
              }
            : undefined,

        userProfilesChatsUserBTouserProfiles:
          data.userProfilesChatsUserBTouserProfiles
            ? {
                connect: data.userProfilesChatsUserBTouserProfiles,
              }
            : undefined,

        userProfilesChatsUsersTouserProfiles:
          data.userProfilesChatsUsersTouserProfiles
            ? {
                connect: data.userProfilesChatsUsersTouserProfiles,
              }
            : undefined,
      },
      select: {
