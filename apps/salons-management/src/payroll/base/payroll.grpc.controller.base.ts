...
export class PayrollGrpcControllerBase {
  ...
  @GrpcMethod("PayrollService", "payrolls")
  ...
  @GrpcMethod("PayrollService", "payroll")
  async payroll(
  ...
  @swagger.ApiOkResponse({ type: Payroll })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("PayrollService", "updatePayroll")
  async updatePayroll(
    @common.Param() params: PayrollWhereUniqueInput,
  ...
  @swagger.ApiOkResponse({ type: Payroll })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("PayrollService", "deletePayroll")
  async deletePayroll(
    @common.Param() params: PayrollWhereUniqueInput
  ): Promise<Payroll | null> {
    try {
