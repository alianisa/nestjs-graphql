  ...
  test("POST /sessions", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        notAfter: CREATE_RESULT.notAfter.toISOString(),
        refreshedAt: CREATE_RESULT.refreshedAt.toISOString(),
      ...
      .expect([
        {
          ...
          notAfter: FIND_MANY_RESULT[0].notAfter.toISOString(),
          refreshedAt: FIND_MANY_RESULT[0].refreshedAt.toISOString(),
  ...
  test("GET /sessions/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        notAfter: FIND_ONE_RESULT.notAfter.toISOString(),
        refreshedAt: FIND_ONE_RESULT.refreshedAt.toISOString(),
