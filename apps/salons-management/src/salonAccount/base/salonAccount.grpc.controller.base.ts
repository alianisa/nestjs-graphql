...
export class SalonAccountGrpcControllerBase {
  ...
  @GrpcMethod("SalonAccountService", "salonAccounts")
  ...
  @GrpcMethod("SalonAccountService", "salonAccount")
  async salonAccount(
  ...
  @swagger.ApiOkResponse({ type: SalonAccount })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("SalonAccountService", "updateSalonAccount")
  ...
  @swagger.ApiOkResponse({ type: SalonAccount })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("SalonAccountService", "deleteSalonAccount")
