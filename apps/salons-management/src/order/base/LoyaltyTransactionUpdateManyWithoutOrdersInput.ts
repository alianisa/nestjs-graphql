...
@InputType()
class LoyaltyTransactionUpdateManyWithoutOrdersInput {
...
export { LoyaltyTransactionUpdateManyWithoutOrdersInput as LoyaltyTransactionUpdateManyWithoutOrdersInput };
