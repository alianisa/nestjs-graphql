...
@InputType()
class AppointmentCreateNestedManyWithoutOrdersInput {
...
export { AppointmentCreateNestedManyWithoutOrdersInput as AppointmentCreateNestedManyWithoutOrdersInput };
