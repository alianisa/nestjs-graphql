...
@InputType()
class UserProfileCreateNestedManyWithoutUserGendersInput {
...
export { UserProfileCreateNestedManyWithoutUserGendersInput as UserProfileCreateNestedManyWithoutUserGendersInput };
